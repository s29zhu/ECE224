...
JDI_FILE := C:/ece224/myESystem/myESystem.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1001150
SOPC_SYSID_FLAG += --sidp=0x1001150
ELF_PATCH_FLAG  += --sidp 0x1001150

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1358285667
SOPC_SYSID_FLAG += --timestamp=1358285667
ELF_PATCH_FLAG  += --timestamp 1358285667
